...
# Barcha kubiklar ro'yxati (Rasmlar vergul bilan ajratilgan matn ko'rinishida)
TOVARLAR = [
    {
        "id": 1,
...
<head>
    ...
    <style>
        ...
        /* Modal ichi: O'ng tomon (Ma'lumotlar) */
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="/qoshish" method="post">
                ...
                <textarea name="rasmlar" placeholder="Rasmlar URL manzillari (Kamida 3 ta, max 10 ta. Har birini vergul (,) bilan ajratib yozing!)" rows="4" required></textarea>
    ...
    <!-- GEYMERLAR MENYUSI (MODAL WINDOW) -->
    <div id="gamerModal" class="modal" onclick="closeModalOutside(event)">
        <div class="modal-content">
            ...
            <!-- Chap tomon: Slayder Rasmlar -->
            <div class="modal-left">
                <div class="main-img-container">
                    <img id="modalMainImg" src="" alt="Asosiy Rasm">
                </div>
                <div id="modalThumbnails" class="thumbnails-grid">
                    <!-- Kichik rasmlar shu yerga tushadi (3 tadan 10 tagacha) -->
                </div>
            </div>
            
            <!-- O'ng tomon: Tavsif va Xizmatlar -->
    ...
    <script>
        // Hamma tovarlarni JS massiviga o'tkazib olamiz
        ...
        function openProduct(id) {
            ...
            // Sarlavha, tavsif va narxni joylash
        ...
        function toggleModal(show) {
            document.getElementById('gamerModal').style.display = show ? 'flex' : 'none';
        }

        function closeModalOutside(e) {
            if(e.target.id === 'gamerModal') toggleModal(false);
        }
        ...
        function applyPromo() {
            ...
            if(code === 'ALPHA40' || code === 'BARAKA') {
                const newPrice = activeBasePrice * 0.9; // 10% chegirma
...
async def bosh_sahifa(request: Request):
    ...
    for tovar in TOVARLAR:
        # Birinchi rasmni asosiy kartochka uchun ajratib olamiz
    ...
    # Ma'lumotlarni JS ga json formatda xavfsiz o'tkazamiz
...
async def yangi_tovar(nomi: str = Form(...), narxi: int = Form(...), brend: str = Form(...), tavsif: str = Form(...), rasmlar: str = Form(...)):
    ...
    # Yangi kubik qo'shganda sharhlar bo'limini bo'sh massiv bilan boshlaymiz
    TOVARLAR.append({
        "id": yangi_id,
        "nomi": nomi,
        "narxi": narxi,
